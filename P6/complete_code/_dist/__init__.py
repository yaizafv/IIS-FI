...
logic = load_compiled_module("calculator_logic", "calculator_logic.cpython-313.pyc")
interface = load_compiled_module("calculator_user_io", "calculator_user_io.cpython-313.pyc")
main_f = load_compiled_module("calculator_main", "calculator_main.cpython-313.pyc")
